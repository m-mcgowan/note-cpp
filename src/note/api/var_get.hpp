...
#pragma GCC diagnostic ignored "-Winvalid-offsetof"
        static constexpr ::note::ReqFieldDesc table_[] NOTE_FLASH_ATTR = {
            {::note::api::VarGet::keys_::file, static_cast<uint16_t>(offsetof(::note::api::VarGet, file)), ::note::ReqFieldType::String},
            {::note::api::VarGet::keys_::name, static_cast<uint16_t>(offsetof(::note::api::VarGet, name)), ::note::ReqFieldType::String},
        };
#pragma GCC diagnostic pop
...
inline void VarGet::build(JsonBuilder& b) const {
...
inline Result<void> VarGet::command() const {
    auto build_ = [&](JsonBuilder& b_) {
        b_.add("cmd", notecard_request);
        this->build(b_);
    };
