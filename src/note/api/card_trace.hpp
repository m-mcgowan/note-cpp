...
template<>
struct request_traits<::note::api::CardTrace> {
    static const ::note::ReqFieldDesc* req_field_descs_ptr_(uint8_t& n_out) {
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Winvalid-offsetof"
        static constexpr ::note::ReqFieldDesc table_[] NOTE_FLASH_ATTR = {
            {::note::api::CardTrace::keys_::mode, static_cast<uint16_t>(offsetof(::note::api::CardTrace, mode)), ::note::ReqFieldType::String},
        };
#pragma GCC diagnostic pop
...
inline void CardTrace::build(JsonBuilder& b) const {
