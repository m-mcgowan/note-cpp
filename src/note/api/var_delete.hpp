...
struct VarDelete {
    ...
    struct file_t : Field<note::string_view> {
        ...
        /// The name of the DB Notefile that contains the Note to delete.
...
template<>
struct request_traits<::note::api::VarDelete> {
    static const ::note::ReqFieldDesc* req_field_descs_ptr_(uint8_t& n_out) {
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Winvalid-offsetof"
        static constexpr ::note::ReqFieldDesc table_[] NOTE_FLASH_ATTR = {
            {::note::api::VarDelete::keys_::file, static_cast<uint16_t>(offsetof(::note::api::VarDelete, file)), ::note::ReqFieldType::String},
            {::note::api::VarDelete::keys_::name, static_cast<uint16_t>(offsetof(::note::api::VarDelete, name)), ::note::ReqFieldType::String},
        };
#pragma GCC diagnostic pop
...
inline void VarDelete::build(JsonBuilder& b) const {
    using meta_ = ::note::detail::request_traits<VarDelete>;
...
#if NOTE_SINGLETON
inline ApiResult<void> VarDelete::execute() const {
...
inline Result<void> VarDelete::command() const {
    auto build_ = [&](JsonBuilder& b_) {
        b_.add("cmd", notecard_request);
        this->build(b_);
    };
