...
#pragma GCC diagnostic pop
        ...
        Result<void>(*command_fn_)(void*, const CardWirelessPenalty::Check&) = nullptr;
...
#pragma GCC diagnostic pop
        ...
        auto execute() const { return execute_fn_(nc_, *this); }
        Result<void>(*command_fn_)(void*, const CardWirelessPenalty::Set&) = nullptr;
        Result<void> command() const { return command_fn_(nc_, *this); }
...
#pragma GCC diagnostic pop
        ...
        auto execute() const { return execute_fn_(nc_, *this); }
        Result<void>(*command_fn_)(void*, const CardWirelessPenalty::Clear&) = nullptr;
        Result<void> command() const { return command_fn_(nc_, *this); }
