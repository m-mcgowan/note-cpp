...
- **[Typed API](docs/using-the-api.md)** — typed requests and responses for all 74 Notecard endpoints; fluent or direct-assignment styles; on C++20 the compiler validates enum fields like `mode` at compile time.
