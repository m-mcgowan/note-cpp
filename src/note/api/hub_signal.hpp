...
template<>
struct request_traits<::note::api::HubSignal> {
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Winvalid-offsetof"
...
#if NOTE_API_VERSION >= NOTE_VERSION(5, 1, 1) || !defined(NOTE_API_STRICT)
            {::note::api::HubSignal::keys_::seconds, static_cast<uint16_t>(offsetof(::note::api::HubSignal, seconds)), ::note::ReqFieldType::Int},
#endif
        };
#pragma GCC diagnostic pop
...
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
inline void HubSignal::build(JsonBuilder& b) const {
#if NOTE_API_VERSION >= NOTE_VERSION(5, 1, 1) || !defined(NOTE_API_STRICT)
#endif
    using meta_ = ::note::detail::request_traits<HubSignal>;
...
#if NOTE_SINGLETON
inline ApiResult<typename HubSignal::Response> HubSignal::execute() const {
