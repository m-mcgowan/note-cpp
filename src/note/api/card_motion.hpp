...
struct CardMotion {
    ...
    struct Response {
        ...
        ~Response() {
            ...
            ::note::detail::deallocate_if_present(*alloc_, movements.value());
...
#pragma GCC diagnostic ignored "-Winvalid-offsetof"
        static constexpr ::note::ReqFieldDesc table_[] NOTE_FLASH_ATTR = {
            {::note::api::CardMotion::keys_::minutes, static_cast<uint16_t>(offsetof(::note::api::CardMotion, minutes)), ::note::ReqFieldType::Int},
        };
#pragma GCC diagnostic pop
...
inline void CardMotion::build(JsonBuilder& b) const {
...
inline Result<void> CardMotion::command() const {
    auto build_ = [&](JsonBuilder& b_) {
        b_.add("cmd", notecard_request);
        this->build(b_);
    };
