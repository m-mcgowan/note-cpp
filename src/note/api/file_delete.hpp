...
template<>
struct request_traits<::note::api::FileDelete> {
    static const ::note::ReqFieldDesc* req_field_descs_ptr_(uint8_t& n_out) {
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Winvalid-offsetof"
        static constexpr ::note::ReqFieldDesc table_[] NOTE_FLASH_ATTR = {
            {::note::api::FileDelete::keys_::files, static_cast<uint16_t>(offsetof(::note::api::FileDelete, files)), ::note::ReqFieldType::Array},
        };
...
inline void FileDelete::build(JsonBuilder& b) const {
    using meta_ = ::note::detail::request_traits<FileDelete>;
...
#if NOTE_SINGLETON
inline ApiResult<void> FileDelete::execute() const {
...
inline Result<void> FileDelete::command() const {
    auto build_ = [&](JsonBuilder& b_) {
        b_.add("cmd", notecard_request);
        this->build(b_);
    };
