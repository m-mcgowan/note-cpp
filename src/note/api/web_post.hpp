...
inline ApiResult<typename WebPost::Response> WebPost::execute() const {
    ...
    using meta_ = ::note::detail::request_traits<WebPost>;
    auto rv_ = meta_::execute_generic_fn_(meta_::nc_, notecard_request, fn_, &build_, &rsp_, meta_::field_descs_ptr(), meta_::field_count, nc_err_, exhausted_, body_ptr_, body_handler_factory_, safety);
