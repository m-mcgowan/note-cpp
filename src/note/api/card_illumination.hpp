...
struct CardIllumination {
    ...
    static constexpr Firmware min_firmware = Firmware{9, 1, 1};
...
template<>
struct request_traits<::note::api::CardIllumination> {
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Winvalid-offsetof"
    static constexpr ::note::FieldDesc field_descs_table_[] NOTE_FLASH_ATTR = {
        {::note::api::CardIllumination::keys_::rsp_value, static_cast<uint16_t>(offsetof(::note::api::CardIllumination::Response, value)), ::note::FieldType::Double},
    };
...
inline ApiResult<typename CardIllumination::Response> CardIllumination::execute() const {
    ...
    using meta_ = ::note::detail::request_traits<CardIllumination>;
...
inline Result<void> CardIllumination::command() const {
    auto build_ = [&](JsonBuilder& b_) {
        b_.add("cmd", notecard_request);
        this->build(b_);
    };
