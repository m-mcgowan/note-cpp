...
#pragma GCC diagnostic ignored "-Winvalid-offsetof"
        static constexpr ::note::ReqFieldDesc table_[] NOTE_FLASH_ATTR = {
            {::note::api::EnvSet::keys_::text, static_cast<uint16_t>(offsetof(::note::api::EnvSet, text)), ::note::ReqFieldType::String},
        };
#pragma GCC diagnostic pop
...
inline void EnvSet::build(JsonBuilder& b) const {
...
inline Result<void> EnvSet::command() const {
    auto build_ = [&](JsonBuilder& b_) {
        b_.add("cmd", notecard_request);
        this->build(b_);
    };
