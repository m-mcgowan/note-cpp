...
// Streaming-only: no JsonBackend needed. Requests streamed via
// StreamingJsonBuilder, responses SAX-parsed via Response::Sink.
static note::Notecard notecard(serial_transport, note::arena_allocator(arena));
