...
If you need to do something the focused API doesn't expose, you can always talk to the underlying Notecard request directly. See [raw-requests.md](raw-requests.md).
...
<!-- Section 5 — written in Task A5. -->

## Reference

<!-- Section 6 — written in Task A6. -->
