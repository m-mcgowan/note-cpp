...
struct WebPut {
    ...
    struct max_t : Field<note::json_int_t> {
        ...
        /// size. Default (and maximum value) is 8192.
        WebPut& operator()(note::json_int_t v);
    } max{};
    ...
    struct payload_t : Field<note::string_view> {
        using Field<note::string_view>::Field;
        using Field<note::string_view>::operator=;
        /// A base64-encoded binary payload. A `web.put` may have either a
...
inline WebPut& WebPut::max_t::operator()(note::json_int_t v) {
...
inline WebPut& WebPut::offset_t::operator()(note::json_int_t v) {
    Field<note::json_int_t>::operator=(v);
    return *reinterpret_cast<WebPut*>(
...
inline WebPut& WebPut::seconds_t::operator()(note::json_int_t v) {
    Field<note::json_int_t>::operator=(v);
    return *reinterpret_cast<WebPut*>(
...
#if NOTE_API_VERSION >= NOTE_VERSION(3, 2, 1) || !defined(NOTE_API_STRICT)
inline WebPut& WebPut::total_t::operator()(note::json_int_t v) {
    Field<note::json_int_t>::operator=(v);
    return *reinterpret_cast<WebPut*>(
...
template<>
struct request_traits<::note::api::WebPut> {
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Winvalid-offsetof"
    static constexpr ::note::FieldDesc field_descs_table_[] NOTE_FLASH_ATTR = {
        {::note::api::WebPut::keys_::rsp_payload, static_cast<uint16_t>(offsetof(::note::api::WebPut::Response, payload)), ::note::FieldType::String},
        {::note::api::WebPut::keys_::rsp_status, static_cast<uint16_t>(offsetof(::note::api::WebPut::Response, status)), ::note::FieldType::String},
        {::note::api::WebPut::keys_::rsp_result, static_cast<uint16_t>(offsetof(::note::api::WebPut::Response, result)), ::note::FieldType::Int},
        {::note::api::WebPut::keys_::rsp_cobs, static_cast<uint16_t>(offsetof(::note::api::WebPut::Response, cobs)), ::note::FieldType::Int},
        {::note::api::WebPut::keys_::rsp_length, static_cast<uint16_t>(offsetof(::note::api::WebPut::Response, length)), ::note::FieldType::Int},
    };
#pragma GCC diagnostic pop
...
inline Result<void> WebPut::command() const {
    auto build_ = [&](JsonBuilder& b_) {
        b_.add("cmd", notecard_request);
        this->build(b_);
    };
