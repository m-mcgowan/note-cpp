...
#pragma GCC diagnostic ignored "-Winvalid-offsetof"
        static constexpr ::note::FieldDesc table[] = {
            {"bytes_per_day", static_cast<uint16_t>(offsetof(Response, bytesPerDay)), ::note::FieldType::Int32},
            ...
            {"days", static_cast<uint16_t>(offsetof(Response, days)), ::note::FieldType::Int32},
...
#pragma GCC diagnostic pop
    ...
    static inline ApiResult<Response>(*execute_fn_)(void*, const CardUsageTest&);
