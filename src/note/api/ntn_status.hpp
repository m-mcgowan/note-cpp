...
struct NtnStatus {
    ...
    static constexpr RadiosSupport radios = RadiosSupport::from(Radios::Cell, Radios::CellWifi, Radios::WiFi);
...
template<>
struct request_traits<::note::api::NtnStatus> {
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Winvalid-offsetof"
    static constexpr ::note::FieldDesc field_descs_table_[] NOTE_FLASH_ATTR = {
        {::note::api::NtnStatus::keys_::rsp_err, static_cast<uint16_t>(offsetof(::note::api::NtnStatus::Response, err)), ::note::FieldType::String},
        {::note::api::NtnStatus::keys_::rsp_status, static_cast<uint16_t>(offsetof(::note::api::NtnStatus::Response, status)), ::note::FieldType::String},
    };
...
inline void NtnStatus::build(JsonBuilder& b) const {
#if NOTE_EXTRAS
...
#if NOTE_SINGLETON
inline ApiResult<typename NtnStatus::Response> NtnStatus::execute() const {
    ...
    using meta_ = ::note::detail::request_traits<NtnStatus>;
